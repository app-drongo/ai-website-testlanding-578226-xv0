...
export default function Footer({
  ...
  companyDescription = 'Empowering businesses with cutting-edge landing page solutions. Create high-converting pages that drive results and grow your business with our professional platform.',
