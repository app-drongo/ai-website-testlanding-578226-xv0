...
const DEFAULT_HERO = {
  badge: 'New: Lightning-Fast Deployment',
  title: 'Ship your tech product',
  titleHighlight: '10x faster',
  description:
    'Build, test, and deploy modern web applications with our streamlined development platform. Perfect for startups and tech teams who need to move fast.',
  features: [
